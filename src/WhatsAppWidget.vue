<template>
  <div id="vwwb-widget-wrapper">
    ...
    <a id="vwwb-widget-button" @click="toggle" :style="{ 'width': props?.button_size || '50px', 'height': props?.button_size || '50px'}">
...
const props = defineProps(["phone", "quick_replies", "button_size"])
