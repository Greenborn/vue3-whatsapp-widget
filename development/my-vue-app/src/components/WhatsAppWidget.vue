<template>
  ...
  <div id="vwwb-widget-wrapper">
    <div id="vwwb-widget-window" style="display: flex;">
      ...
      <div id="vwwb-main-row">
        <div id="vwwb-default-text">Hola, ¡me interesa Greenborn!</div>
        <button id="vwwb-send-button">
